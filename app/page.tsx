...
export default function Home(){return <main className="premiumHome">
  ...
  <section className="homeSocial" aria-labelledby="home-social-title"><div><small>BERKER MAKİNE SOSYAL MEDYA</small><h2 id="home-social-title">Bizi takip edin</h2><p>Yeni makineler, uygulama videoları ve güncel duyurular için resmi kanallarımızı ziyaret edin.</p></div><nav aria-label="Sosyal medya bağlantıları"><a href="https://web.telegram.org/k/#/im?p=@BerkerMakine" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">TG</span><b>Telegram</b></a><a href="https://www.youtube.com/channel/UC69kmlibDul1XBaHWMlg-OQ" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">YT</span><b>YouTube</b></a><a href="https://channels.bip.ai/join/berkermakine" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">BiP</span><b>BiP</b></a><a href="https://www.instagram.com/berkermakine/" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">IG</span><b>Instagram</b></a><a href="https://www.facebook.com/BerkerMakine" target="_blank" rel="noopener noreferrer"><span aria-hidden="true">f</span><b>Facebook</b></a></nav></section>
